...
const BENEFITS = [
  ...
  { icon: Calculator, title: "Instant quotes", body: "Visitors answer a few questions and get a real price range — you get a qualified lead." },
  { icon: CalendarCheck, title: "Online booking", body: "Customers book while you're on the job. Confirm or reschedule in two taps." },
  { icon: Users, title: "Built-in CRM", body: "Every lead in one pipeline from first contact to paid customer. Nothing gets lost." },
  { icon: Star, title: "Review engine", body: "Automated review requests after every job build the proof that wins the next customer." },
  { icon: LineChart, title: "See what's working", body: "Know exactly which pages, ads and channels produce paying customers." },
] as const;
      ...
      scripts: [
        {
          ...
          children: JSON.stringify({
            ...
            offers: {
              "@type": "Offer",
              priceSpecification: [
                { "@type": "PriceSpecification", price: 1500, priceCurrency: "USD", description: "One-time setup" },
                { "@type": "UnitPriceSpecification", price: 250, priceCurrency: "USD", unitText: "MONTH" },
              ],
            },
          }),
        },
    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="hero-aura mx-auto max-w-6xl px-4 py-16">
        ...
        <p className="mt-4 max-w-xl text-[15px] leading-relaxed text-muted-foreground">
          ...
          capture every lead, quote instantly, book customers online and follow up automatically — so
          no opportunity slips while you're working.
        </p>
