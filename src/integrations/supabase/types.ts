...
export type Database = {
  ...
  public: {
    ...
    Enums: {
      ...
      conversion_goal: "calls" | "quotes" | "bookings" | "consultations" | "purchases";
      domain_status:
        "not_connected" | "dns_pending" | "verifying" | "connected" | "ssl_active" | "error";
      lead_status: "new" | "contacted" | "qualified" | "quoted" | "booked" | "completed" | "lost";
      payment_product_kind:
        "one_time" | "subscription" | "setup_fee" | "deposit" | "addon" | "service";
      payment_status:
        | "created"
        | "pending"
        | "approved"
