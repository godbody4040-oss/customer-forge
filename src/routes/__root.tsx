...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Local Lead Engine — Turn visitors into booked customers" },
      {
        name: "description",
        content:
          "Local Lead Engine gives local businesses the website, lead capture, booking and follow-up tools that turn online visitors into real customers.",
      },
      { name: "author", content: "Local Lead Engine" },
