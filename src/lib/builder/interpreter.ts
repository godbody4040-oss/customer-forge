...
export function interpret(
   ...
   *
   * SAFETY FIX (Phase 1): this used to also set wholeSite = true whenever
   * the "redesign" goal matched, and GOAL_WORDS.redesign includes the word
   * "refresh". That meant an ordinary request like "refresh the hero
   * headline" was silently treated as a full-site rebuild instruction,
   * contradicting the safety principle stated above. wholeSite must only be
